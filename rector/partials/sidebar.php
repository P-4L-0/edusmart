...
<div class="bg-blue-800 text-white w-64 min-h-screen p-4">
    ...
    <nav>
        <ul class="space-y-2">
            ...
            <li>
                <a href="maestros.php" class="block px-4 py-2 rounded-lg bg-blue-700">Maestros</a>
            </li>
            <!--
            <li>
...
-->
            ...
            <li>
                        <a href="reportes.php" class="block px-4 py-2 rounded-lg hover:bg-blue-700">Reportes</a>
                    </li>
            <li>
