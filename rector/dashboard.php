            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between border-b pb-2">
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo date('d/m/Y', strtotime($maestro->fecha_creacion)); ?></p>
                            </div>
                            <a href="maestros.php?ver=<?php echo $maestro->id; ?>" class="text-blue-500 hover:text-blue-700 text-sm">Ver</a>
                        </div>
                        <?php endforeach; ?>
                        
                        <div class="mt-4">
                            <a href="maestros.php" class="text-blue-500 hover:text-blue-700">Ver todos los maestros →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between border-b pb-2">
                            <div>
                                <p class="font-medium"><?php echo htmlspecialchars($grupo->nombre); ?> - <?php echo htmlspecialchars($grupo->grado); ?></p>
                                <p class="text-sm text-gray-500">
                                    <?php echo $grupo->maestro ? 'Maestro: ' . htmlspecialchars($grupo->maestro) : 'Sin maestro asignado'; ?>
                                </p>
                            </div>
                            <a href="grupos.php?ver=<?php echo $grupo->id; ?>" class="text-blue-500 hover:text-blue-700 text-sm">Ver</a>
                        </div>
                        <?php endforeach; ?>
