...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-evenly">
        <img src="./srcs/undraw_books_wxzz.svg" alt="svg libros" class="w-96 h-96">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"  autocomplete="off" required>
                </div>
        ...
        <img src="./srcs/undraw_education_3vwh.svg" alt="svg libros persona" class="w-96 h-96" >
    </div>
</body>
</html>