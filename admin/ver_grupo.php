...
<body class="bg-gray-100">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    ...
                    <div class="flex items-center mt-2 text-gray-600">
                        <span class="mr-4"><i class="fas fa-graduation-cap mr-2"></i><?= htmlspecialchars($grupo->grado) ?></span>
                        <span><i class="fas fa-calendar-alt mr-2"></i><?= htmlspecialchars($grupo->ciclo_escolar) ?></span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-3">
                            <button onclick="document.getElementById('modal-asignar-maestro').classList.remove('hidden')"
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">NIE</th>
    ...
    <div id="modal-asignar-maestro" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-semibold">Asignar Maestro</h3>
                    <button onclick="cerrarModal('modal-asignar-maestro')" class="text-gray-500 hover:text-gray-700">&times;</button>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button onclick="cerrarModal('modal-agregar')" class="text-gray-500 hover:text-gray-700">&times;</button>
                </div>
                <form id="form-agregar" method="POST" action="agregar_estudiante.php">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="nombre" name="nombre_completo" class="w-full px-3 py-2 border rounded-lg" required>
                        </div>
                    </div>
                ...
                <form id="form-editar" method="POST" action="editar_estudiante.php">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="edit-nie" name="nie" class="w-full px-3 py-2 border rounded-lg" required>
                        </div>
                        
                        <div>
                            <label for="edit-nombre" class="block text-gray-700 mb-2">Nombre Completo</label>
                            <input type="text" id="edit-nombre" name="nombre_completo" class="w-full px-3 py-2 border rounded-lg" required>
                        </div>
                    </div>
    ...
    <div id="modal-importar" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-semibold">Importar Estudiantes</h3>
                    <button onclick="cerrarModal('modal-importar')" class="text-gray-500 hover:text-gray-700">&times;</button>
                </div>
                <form action="importar_estudiantes.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="archivo" name="archivo" accept=".xlsx,.xls" class="w-full px-3 py-2 border rounded-lg" required>
    ...
    // Editar estudiante
    function editarEstudiante(id, nombre, nie) {
        document.getElementById('edit-id').value = id;
        document.getElementById('edit-nie').value = nie;
